...
function Recommended({
  ...
  return (
    <div className="px-5 py-4 md:px-8 md:py-6 lg:container" data-aos="fade-up" id="recommended">
      <div>
      ...
      <div className="grid-cols-auto-fit grid gap-6 items-center justify-items-center">
        {shownCars}
      </div>
    </div>
  );
...
function Card({ item, likedProducts, setLikedProducts, setPayProduct }) {
  ...
  return (
    <div
      className="px-5 py-4 md:px-8 md:py-6 hover:scale-[1.05] transition duration-300">
